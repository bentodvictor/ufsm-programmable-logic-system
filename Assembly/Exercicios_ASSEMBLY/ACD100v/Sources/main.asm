...
loop:    
         ...
         ;temos os 12 bits do ADC em lido.
          ;para ter um número entre 0 e 100V temos que dividir 4095 pra que fique sendo 100.
           ;4095/41 =~ 100
           ...
           ;A tem a resposta entre 0 e 100, porém só vai 49 ou 99.
           add #1  ;só pra deixar bem certinho
           sta PTBD    ;0->100 está em PTB
