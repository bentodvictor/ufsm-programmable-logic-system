...
loop:      
          LDA #10      ; AC RECEBE 10
          STA cont 
          LDX #0         ;POSIÇÃO DO VETOR  X RECEBE 0
          
 inicio:  LDA cont       ; ac receb cont
          STA lido, X   ;salva o numero 100 na variavel lido + 9     LIDO[X] RECEBE 10
          ADD #10       ;AC RECEBE AC + 10
          STA cont      ;cont RECEBE AC
          
          INCX          ; x++
          STX temp      ; tem recebe x
          
          LDA temp      ; acc recebe temp
          SUB #10       ;acc recebe acc - 10
          BNE inicio    ; se acc !=0 vai paraa o inicio
