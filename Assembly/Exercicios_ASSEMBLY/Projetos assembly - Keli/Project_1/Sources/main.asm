...
loop:      
          LDA #100      ; AC RECEBE 100
          LDX #9         ;POSIÇÃO DO VETOR  X RECEBE 9
          
 inicio:  STA lido, X   ;salva o numero 100 na variavel lido + 9     LIDO[X] RECEBE 100
          SUB #10       ;AC RECEBE AC - 10
          DBNZX inicio  ; X--, SE X!= 0 PULA PAAR INICIO
